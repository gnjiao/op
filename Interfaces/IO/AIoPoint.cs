...
namespace CMotion.Interfaces.IO
{
    ...
    ///     表示一个通讯开关量。
    /// </summary>
    public class AIoPoint : Automatic
    {
        /// <summary>
        ///     构造函数
        /// </summary>
        ...
        ///     读写控制器
        /// </summary>
        protected IAnalogController Controller { get; private set; }
...
#pragma warning disable CS1591 // 缺少对公共可见类型或成员“AIoPoint.ToString()”的 XML 注释
        public override string ToString()
#pragma warning restore CS1591 // 缺少对公共可见类型或成员“AIoPoint.ToString()”的 XML 注释
        {
