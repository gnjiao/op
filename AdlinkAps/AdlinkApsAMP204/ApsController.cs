...
namespace CMotion.AdlinkAps_AMP204
{
    ...
    public class ApsController : IAxisControl, ISwitchController, IMotionController, IDisposable
    {
        ...
        {          
            return APS168.APS_load_param_from_file(xmlfilename) == 0;
        }
        #endregion
        ...
        /// </summary>
        /// <param name="noId"></param>
        public override void ServoOn(short noId)
        {
        ...
        /// </summary>
        /// <param name="noId"></param>
        public override void ServoOff(short noId)
        {
