...
namespace Motion.Tray
{
    public partial class uTrayPanel : UserControl
    {
        ...
        int Col = 3;
        Tray t = null;
        public void SetTrayObj(Tray tray, Color initColor, int size = 32)
        {
            t = tray;
            Row = t.Row;
            Col = t.Column;
            SetLayout(initColor, size);
        }
        ...
        private void DynamicLayout(TableLayoutPanel layoutPanel, Color bColor, int size = 32)
        {
